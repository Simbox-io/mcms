...
const Card: React.FC<CardProps> = ({
  ...
  return (
    <div className={`bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden ${className}`} onClick={handleClick}>
    <motion.div
    ...
    >
      {title && (
        <motion.div
          ...
          transition={{ duration: 0.3 }}
        >
          <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100 flex items-center justify-between">
            {title}
            {collapsible && (
              <motion.span
