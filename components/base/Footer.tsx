    ...
    const fetchFooterSettings = async () => {
      try {
        ...
        if (response.data) {
          ...
          setCopyrightText(response.data.copyrightText || '');
          // Only hide powered by message if both custom texts are provided
          setShowPoweredBy(!(response.data.footerText && response.data.copyrightText));
        }
      } catch (error) {
