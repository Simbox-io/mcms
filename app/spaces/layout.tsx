...
export default function SpacesLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="container px-4 mx-auto grid h-full w-full lg:grid-cols-[280px_1fr]">
      <div className="hidden bg-zinc-100/40 lg:block dark:bg-zinc-900/40 ">
        <div className="flex h-full max-h-screen flex-col gap-2">
          <div className="flex h-[60px] items-center px-7 mt-4">
            <div className="flex items-center gap-2 font-semibold">
              <Package2Icon className="h-6 w-6" />
              <span className="text-2xl">Spaces</span>
            </div>
            <Button className="ml-auto px-3 text-2xl" size="sm">
