// app/projects/trending/page.tsx
'use client';
...
const TrendingProjectsPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const cacheKey = `/api/projects/trending`;
        ...
        if (cachedData) {
          ...
          if (response.status === 200) {
            ...
            console.error('Error fetching trending projects:', response.statusText);
          }
        }
      } catch (error) {
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mb-4">Trending Projects</h2>
      {isLoading ? (
